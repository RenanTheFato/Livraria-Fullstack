...
function LoginPublisher() {
  ...
  return (
    <main className="w-full min-h-screen bg-[url('/Icon-Grid.svg')] bg-no-repeat bg-cover text-white flex flex-col">
      <div className="flex flex-1">
        <aside className="w-2/5 bg-black bg-[url('/loginPublisher.jfif')] bg-no-repeat bg-cover">
        </aside>
